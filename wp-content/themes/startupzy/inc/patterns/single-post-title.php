...
return array(
	...
	'content'    => '
                ...
                <div class="wp-block-group" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:cover {"url":"' . esc_url( STARTUPZY_URI ) . 'assets/img/african-african-american-afro-american-black-black-african-american-1452617-pxhere.com.webp","id":132,"dimRatio":92,"customOverlayColor":"#02132d","focalPoint":{"x":"0.50","y":"1.00"},"minHeight":520,"contentPosition":"center center","style":{"spacing":{"padding":{"bottom":"200px","top":"0px","right":"0px","left":"0px"}}}} -->
                <div class="wp-block-cover" style="padding-top:0px;padding-right:0px;padding-bottom:200px;padding-left:0px;min-height:520px"><span aria-hidden="true" class="has-background-dim-90 wp-block-cover__gradient-background has-background-dim" style="background-color:#02132d"></span><img class="wp-block-cover__image-background wp-image-132" alt="" src="' . esc_url( STARTUPZY_URI ) . 'assets/img/african-african-american-afro-american-black-black-african-american-1452617-pxhere.com.webp" style="object-position:50% 100%" data-object-fit="cover" data-object-position="50% 100%"/><div class="wp-block-cover__inner-container"><!-- wp:template-part {"slug":"header","theme":"startupzy"} /-->
