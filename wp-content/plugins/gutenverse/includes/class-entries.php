...
class Entries {
	...
	public function entry_data_metabox( $post ) {
		...
		$result = '<div class="entry-title"><strong>Entry ID</strong></div>
		<div class="entry-body">' . $post->ID . '</div>
		<div class="entry-title"><strong>Entry Data</strong></div>
		...
		if ( isset( $entry ) ) {
			foreach ( $entry as $item ) {
				...
				$result .= '<div class="entry-data">
					<div><strong>' . $item['id'] . ' : </strong>' . $value . '</div>
				</div>';
			}
		}
	...
	public function form_data_metabox( $post ) {
		...
		if ( $form_id ) {
			...
			$result = '<div class="entry-title"><strong>Form ID</strong></div>
			<div class="entry-body">' . $form_id . '</div>
			<div class="entry-title"><strong>Form Action</strong></div>
			<div class="entry-body"><strong><a href="' . $form_link . '">' . $form_title . '</a></strong></div>';
		} else {
			$result = '<div class="entry-title"><strong>Form ID</strong></div>
			<div class="entry-body">' . __( 'not found', 'gutenverse' ) . '</div>
			<div class="entry-title"><strong>Form Action</strong></div>
			<div class="entry-body">' . __( 'no title', 'gutenverse' ) . '</div>';
		}
	...
	public function browser_data_metabox( $post ) {
		...
		$result  = '<div class="entry-title"><strong>IP</strong></div>
		<div class="entry-body">' . $browser['ip'] . '</div>
		<div class="entry-title"><strong>Browser Data</strong></div>
		<div class="entry-body">' . $browser['user_agent'] . '</div>';
