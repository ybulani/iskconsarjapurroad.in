...
class Social_Share_Stumbleupon extends Block_Abstract {
	...
	public function render_gutenberg() {
		...
		return "<div class='gutenverse-share-stumbleupon gutenverse-share-item' id='{$this->attributes['elementId']}'>
			<a href='#'>
				{$content}
			</a>
		</div>";
	...
	public function render_frontend() {
		...
		$share_url        = 'http://www.stumbleupon.com/submit?url=' . $encoded_post_url . '&title=' . $title;
		$content          = $this->render_content();
